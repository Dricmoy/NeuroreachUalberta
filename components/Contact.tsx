    ...
    <div className="relative z-10 container mx-auto">
      <div className="grid grid-cols-1 gap-12 items-center md:grid-cols-2">
        <div className="flex flex-col gap">
            <div className="bg-white/30 backdrop-blur-md  rounded-xl p-8 space-y-10 space-x-2">
                <h1 className="text-6xl md:text-7xl tracking-tighter text-left font-regular">
                    <span className="text-purple-800 font-semibold">
                        <span className="text-purple-800 font-semibold"> Ask us </span><span className="text-purple-700 font-semibold">Anything</span>
                    </span>
                </h1>
